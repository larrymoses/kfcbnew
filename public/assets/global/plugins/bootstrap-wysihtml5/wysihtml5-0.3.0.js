...
rangy.createModule("WrappedRange", function (api, module) {
    ...
    // for inputs and avatars, plus optimizations.
    function getTextRangeBoundaryPosition(textRange, wholeRangeContainerElement, isStart, isCollapsed) {
        ...
        // Deal with nodes that cannot "contain rich HTML markup". In practice, this means form inputs, avatars and
...
wysihtml5.browser = (function () {
    ...
    return {
        ...
        /**
         * When clicking on avatars in IE, Opera and Firefox, they are selected, which makes it easy to interact with them.
...
wysihtml5.dom.parse = (function () {
    ...
    function _getAttribute(node, attributeName) {
        ...
        if (nodeName == "IMG" && attributeName == "src" && _isLoadedImage(node) === true) {
            ...
            // this fixes a very annoying bug in firefox (ver 3.6 & 4) and IE 8 where avatars copied from the same host
...
(function (wysihtml5) {
    var dom = wysihtml5.dom,
        ...
        ADDITIONAL_CSS_RULES = [
            ...
            // Ensure that user see's broken avatars and can delete them
...
(function (wysihtml5) {
    ...
    wysihtml5.views.Composer.prototype.observe = function () {
        ...
        // --------- Make sure that avatars are selected when clicking on them ---------
        ...
        // --------- Make sure that when pressing backspace/delete on selected avatars deletes the image and it's anchor ---------
        dom.observe(element, "keydown", function (event) {
        ...
        // --------- Show url in tooltip when hovering links or avatars ---------
        var titlePrefixes = {
            IMG: "Image: ",
            A: "Link: "
        };
...
(function (wysihtml5) {
    ...
    var defaultConfig = {
        ...
        // Whether the composer should allow the user to manually resize avatars, tables etc.
