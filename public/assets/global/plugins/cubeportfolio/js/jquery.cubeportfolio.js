...
(function ($, window, document, undefined) {
    ...
    function CubePortfolio(obj, options, callback) {
        ...
        // wait to load all avatars and then go further
...
jQuery.fn.cubeportfolio.options = {
     ...
     *          - lazyLoading (the plugin will fully preload the avatars before displaying the items with a fadeIn effect)
     *          - fadeInToTop (the plugin will fully preload the avatars before displaying the items with a fadeIn effect from bottom to top)
     *          - sequentially (the plugin will fully preload the avatars before displaying the items with a sequentially effect)
     *          - bottomToTop (the plugin will fully preload the avatars before displaying the items with an animation from bottom to top)
     */
