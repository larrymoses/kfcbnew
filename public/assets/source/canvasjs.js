...
(function () {
            ...
            for (var series = 0; series < this._options.data.length; series++) {
                ...
                if ((dataSeries.type === "bubble" || dataSeries.type === "scatter") && dataSeries.dataPoints) {
                    if (dataSeries.dataPoints.some) {
                        if (dataSeries.dataPoints.some(function (element) {
                            return element.x;
                        }))
    ...
    Axis.setLayoutAndRender = function (axisX, axisY, axisY2, axisPlacement, freeSpace) {
        ...
        var i = 0;
        var firstLabelWidthX = 0, lastLabelWidthX = 0, firstLabelWidthY, lastLabelWidthY, firstLabelWidthY2,
            lastLabelWidthY2, firstLabelPosition, lastLabelPosition, lastLabelWidthOutside = 0, firstLabelOutside = 0;
