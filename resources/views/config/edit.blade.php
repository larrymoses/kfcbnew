...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('config',$config->id)}}">Edit</a>
            </li>
        </ul>
        ...
        <div class="col-md-6">
            <div class="portlet box blue ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cog"></i> Edit {{$config->configname}}
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" method="PATCH" action="{{route('tekeconfig.update',$config->id)}}">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control input" VALUE="{{$config->configname}}"
                                           placeholder="Config Name" name="configname" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control input" VALUE="{{$config->configvalue}}"
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="tel" class="form-control input" VALUE="{{$config->description}}"
