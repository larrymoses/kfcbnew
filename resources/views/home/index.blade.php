            ...
            <a href="{{url('users')}}">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat blue">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$data['users']}}">0</span>
                            </div>
            ...
            <a href="{{url('usergroups')}}">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$data['groups']}}">0</span>
                            </div>
                            <div class="desc">Goups</div>
                        </div>
                        <span class="more"> View more
                        <i class="m-icon-swapright m-icon-white"></i>
                    </span>
            ...
            <a href="{{url('films')}}">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple">
                        ...
                        <div class="details">
                            <div class="number">
                                <span data-counter="counterup" data-value="{{$data['films']}}">0</span>
                            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat purple">
                    ...
                    <div class="details">
                        ...
                        <div class="desc"> Total Films</div>
                    </div>
