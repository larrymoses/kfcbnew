                            ...
                            <div class="portlet-body">
                                <form id="form2" class="form-horizontal form-bordered">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <span class="text-danger text-bold" id="sysRating">0 </span>:<span
                                                class="text-danger text-bold" id="sysRatingWords">GE</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="3" id="enterComment"
                                                      name="enterSynopsis" required></textarea>
                                        </div>
                                    </div>
