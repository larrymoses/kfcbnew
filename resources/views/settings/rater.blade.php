                ...
                <div class="profile-sidebar">
                    ...
                    <div class="portlet light profile-sidebar-portlet ">
                        ...
                        <div class="profile-usertitle">
                            <div
                                class="profile-usertitle-name"> {{Auth::User()->first_name . ' '.Auth::User()->last_name}} </div>
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <form role="form" action="#">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="KFCB Client" class="form-control"
                                                           disabled/></div>
                                                <div class="form-group">
                                                    <label class="control-label">About</label>
                                                    <textarea class="form-control" rows="3"
                                                              value="{{Auth::User()->about}}">{{Auth::User()->about}}</textarea>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="tab-pane" id="tab_1_3">
                                            <form action="{{url('rater/profile')}}" method="post"
                                                ...
                                                <div
                                                    class="form-group{{ $errors->has('newpassword') ? ' has-error' : '' }}">
                                                ...
                                                <div
                                                    class="form-group{{ $errors->has('confirm_newpassword') ? ' has-error' : '' }}">
                                                    <label class="control-label">Re-type New Password</label>
                                                    <input type="password" id="confPassword" name="confirm_newpassword"
                                                           class="form-control"/>
                                                ...
                                                <div class="margin-top-10">
                                                    <button type="submit" id="" class="btn green"> Change Password
                                                    </button>
                                                    <a href="javascript:;" class="btn default"> Cancel </a>
                                                </div>
                                            </form>
