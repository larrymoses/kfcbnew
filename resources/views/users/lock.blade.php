...
<head>
    <meta charset="utf-8"/>
    <title>Metronic | User Lock Screen</title>
...
<div class="page-lock">
    ...
    <div class="page-body">
        <img class="page-lock-img" src="{{asset(Auth::User()->avatar)}}" alt="">
        <div class="page-lock-info">
            ...
            <form class="form-inline" role="form" method="POST" action="{{ url('/login') }}">
                ...
                <!-- /input-group -->
                <div class="relogin">
                    <a href="{{url('logout')}}">Not {{Auth::User()->first_name . ' '.Auth::User()->last_name}} ? </a>
                </div>
            </form>

        </div>
    </div>
    <div class="page-footer-custom"> 2016 &copy; MzikiTrak. Powered By <a href="http://flag42.com/">FLAG42</a>.</div>
</div>
<!--[if lt IE 9]>
